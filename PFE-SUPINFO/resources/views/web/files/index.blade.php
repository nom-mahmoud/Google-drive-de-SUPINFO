...
<div class="file-manager-header">
    ...
    <div class="file-manager-actions">
        ...
        <button class="btn btn-outline" id="btn-new-folder">
...
<div class="upload-zone" id="upload-zone">
    <svg class="upload-zone-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>
    <p id="upload-text" style="font-weight:500; color:var(--text-main);">Glissez-déposez vos fichiers ici ou cliquez pour sélectionner</p>
    <p style="font-size: 0.85rem; color: var(--text-muted); margin-top:0.5rem;">Formats acceptés : PDF, Images, Documents — Max 50 Mo</p>
...
<div class="file-grid" id="file-grid">
    ...
    <div class="file-card" data-type="folder">
        <div class="file-actions">
            <button class="action-btn" title="Renommer"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></button>
            <button class="action-btn danger" title="Supprimer"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg></button>
        </div>
    ...
    <div class="file-card" data-type="folder">
        ...
        <div class="file-meta">34 éléments • Modifié il y a 3j</div>
    </div>

    <!-- Fichiers -->
    <div class="file-card" data-type="pdf">
        <div class="file-actions">
            <button class="action-btn" title="Télécharger"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg></button>
            <button class="action-btn danger" title="Supprimer"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg></button>
        </div>
    ...
    <div class="file-card" data-type="image">
        ...
        <div class="file-name">architecture_diagram.png</div>
        <div class="file-meta">890 Ko • 12 mai 2026</div>
    </div>
    <div class="file-card" data-type="doc">
        <div class="file-actions">
            <button class="action-btn" title="Télécharger"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg></button>
            <button class="action-btn danger" title="Supprimer"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg></button>
        </div>
        <svg class="file-icon" viewBox="0 0 24 24" fill="none" stroke="#2563EB" stroke-width="1.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
        <div class="file-name">notes_reunion.docx</div>
        <div class="file-meta">156 Ko • 10 mai 2026</div>
    </div>
</div>
...
<div class="modal-overlay" id="folder-modal">
    <div class="modal-card bento-card">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-input" placeholder="Mon nouveau dossier" autofocus>
        </div>
        <div class="flex gap-4" style="justify-content:flex-end;">
            <button class="btn btn-outline" id="folder-modal-close">Annuler</button>
...
<div class="trash-banner" style="margin-top: 2rem;">
    ...
    <span>La corbeille contient <strong>3 éléments</strong></span>
    <a href="#" class="btn btn-outline" style="padding:0.4rem 1rem; font-size:0.85rem; margin-left:auto;">Voir la corbeille</a>
</div>
@endsection
