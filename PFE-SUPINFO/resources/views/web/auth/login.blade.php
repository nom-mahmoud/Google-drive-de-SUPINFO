...
<div class="auth-wrapper" style="min-height: calc(100vh - 80px);">
    <div class="auth-container bento-card" style="margin: 0 auto;">
        ...
        <div class="flex flex-col gap-2">
            <a href="{{ route('oauth.google') ?? '#' }}" class="btn btn-outline w-full flex items-center justify-center gap-2">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                Google
            </a>
            <a href="{{ route('oauth.github') ?? '#' }}" class="btn btn-outline w-full flex items-center justify-center gap-2">
